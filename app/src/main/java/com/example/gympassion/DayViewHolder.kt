...
class DayViewHolder(
    ...
    val exercisesRecyclerView: RecyclerView = itemView.findViewById(R.id.exercises_recycler_view)
    ...
    private fun createExercisesAdapter(isEditing: Boolean): ExercisesAdapter {
        val layoutId =
            if (isEditing) R.layout.exercise_edit_list_item else R.layout.exercise_list_item
    ...
    fun addExercise(exercise: Exercise) {
        Log.d(
            "DayViewHolder",
            "Before adding exercise: isAddedToDay = ${exercise.isAddedToDay}"
        )
        val currentDay = day
        ...
        Log.d(
            "DayViewHolder",
            "After adding exercise: isAddedToDay = ${exercise.isAddedToDay}"
        )
        Log.d(
            "DayViewHolder",
            "Added exercise: ${exercise.name} to day: ${currentDay?.title}"
        )
    }
